...
const LogIn = () => {
    ...
    const Check = () =>{
        if(password === users[id-1].username){
            localStorage.setItem('isLogin',JSON.stringify(users[id-1]));
            alert("match")
        ...
        <>
            ...
            <div className="login" >
                <form className="form-signin">
                    ...
                    <input type="email" id="inputEmail" className="form-control" placeholder="Email address" required  value={users[id-1].email} readOnly/>
